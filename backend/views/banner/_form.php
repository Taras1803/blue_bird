        ...
        <div class="tab-content">
            <?php foreach ($langs as $key => $item): ?>
                <div class="tab-pane <?= ($key == 0) ? 'active' : '' ?>" id="tab_<?= $key ?>">
                    ...
                    <?= $form->field($descriptions[$item->id], 'little_title')->textInput(['maxlength' => true, 'id' => 'BannerDescription' . $item->id . '-little_title', 'name' => 'BannerDescription' . $item->id . '[little_title]']) ?>
